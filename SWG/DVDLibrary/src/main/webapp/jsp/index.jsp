    ...
    <body>
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <span class="new-navbar-brand"><a href="${pageContext.request.contextPath}/index">DVD Library</a></span>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#" id="toggleSidebarAdd"><span class="glyphicon glyphicon-plus"></span><span class="sr-only">Add</span></a></li>
                        <li><a href="#" id="toggleSidebarSearch"><span class="glyphicon glyphicon-search"></span><span class="sr-only">Search</span></a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="hidden" id="sidebarAdd">
                    <div class="row">
                ...
                <div class="hidden" id="sidebarSearch">
                    <div class="col-xs-10 col-xs-offset-1">
                        <div class="row"><h3>Search</h3></div>
                            <!--<div id="validationErrors" class="warning bg-danger"></div>-->
                            <form class="form-vertical" role="form">
                                <div class="form-group">
                                    <label for="search-title">Title</label><br>
                                    <input type="text" class="form-control" id="search-title" placeholder="DVD Title" />
                                </div>
                                <div class="form-group">
                                    <label for="search-ratingUS">MPAA Rating</label><br>
                                    <select class="form-control" id="search-ratingUS">
                                        <option value="" selected="selected">Select an MPAA rating:</option>
                                        <option value="G">G</option>
                                        <option value="PG">PG</option>
                                        <option value="PG-13">PG-13</option>
                                ...
                                <div class="form-group">
                                    <label for="search-releaseDate">Release Year</label><br>
                                    <input type="text" class="form-control" id="search-releaseDate" placeholder="Release Year" />
                                </div>
                                <div class="form-group">
                                    <label for="search-directorName">Director Name</label><br>
                                    <input type="text" class="form-control" id="search-directorName" placeholder="Director Name" />
                                </div>
                                <div class="form-group">
                                    <label for="search-studioName">Studio Name</label><br>
                                    <input type="text" class="form-control" id="search-studioName" placeholder="Studio Name" />
                                </div>
                                <div class="form-group">
                                    <label for="search-userRating">User Rating</label><br>
                                    <select class="form-control" id="search-userRating">
                                        <option value="" selected="selected">Select your rating of this DVD:</option>
                                        <option value="5">&#9733;&#9733;&#9733;&#9733;&#9733;</option>
                                        <option value="4">&#9733;&#9733;&#9733;&#9733;</option>
                                        <option value="3">&#9733;&#9733;&#9733;</option>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" onclick="toggleDetailsEdit()">Edit or Delete</button>
                    ...
                    <div class="modal-content">
                        <div class="collapse" id="modalEditDiv">
                        <div class="modal-body">
                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-4 col-md-8">
                                        <button type="submit" id="edit-button" class="btn btn-default" data-dismiss="modal" onclick="toggleDetailsEdit()">Edit Entry</button>
                                        <button type="submit" id="delete-button" class="btn btn-default" data-dismiss="modal" onclick="toggleDetailsEdit()">Delete Entry</button>
                                        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="toggleDetailsEdit()">Cancel</button>
